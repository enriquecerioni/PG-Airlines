...
function Filter({
  ...
  return (
    <div
      className={darkMode ? style.main_container_dark : style.main_container}
    >
      <h2 className={darkMode ? style.textColor_dark : style.textColor}>
        Filter by:
      </h2>
      <label className={darkMode ? style.textColor_dark : style.textColor}>
        Price:{" "}
      </label>
      ...
      <div>
        <Autocomplete
          ...
          renderInput={(params) => (
            <TextField {...params} label="By Airlines" />
          )}
        />
      </div>
      ...
      <h2>Order:</h2>
      <div>
        <FormControl sx={{ m: 1, minWidth: 250, color: '#fff' }}>
